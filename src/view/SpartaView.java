...
public class SpartaView extends JPanel implements ActionListener {
	...
	SpartaView(GameView GameView) {
		Cairo = new JLabel("Sparta");
	...
	public void ishantate(int ind) {
		...
		for (int i = 0; i < GameView.getGame().getPlayer().getControlledCities().size(); i++) {
			if (GameView.getGame().getPlayer().getControlledCities().get(i).getName().equalsIgnoreCase("sparta")) {
	...
	public void actionPerformed(ActionEvent e) {
			...
			if (n == 0) {
				if (ArcheryRange.isVisible())
					JOptionPane.showMessageDialog(this, "YOU HAVE ALREADY BUILT ONE!!", "ERROR!!!!!",
							JOptionPane.ERROR_MESSAGE);
				try {
					GameView.getGame().getPlayer().build("ArcheryRange", "Sparta");
			...
			if (n == 4) {
				if (Market.isVisible())
					JOptionPane.showMessageDialog(this, "YOU HAVE ALREADY BUILT ONE!!", "ERROR!!!!!",
							JOptionPane.ERROR_MESSAGE);
				try {
					GameView.getGame().getPlayer().build("Market", "Sparta");
				} catch (NotEnoughGoldException e1) {
					e1.printStackTrace();
					JOptionPane.showMessageDialog(this, "NOT ENOUGH GOLD!!", "ERROR!!!!!", JOptionPane.ERROR_MESSAGE);
					return;
			...
			if (n == 2) {
				if (Stable.isVisible())
					JOptionPane.showMessageDialog(this, "YOU HAVE ALREADY BUILT ONE!!", "ERROR!!!!!",
							JOptionPane.ERROR_MESSAGE);
				try {
					GameView.getGame().getPlayer().build("Stable", "Sparta");
				} catch (NotEnoughGoldException e1) {
					e1.printStackTrace();
					JOptionPane.showMessageDialog(this, "NOT ENOUGH GOLD!!", "ERROR!!!!!", JOptionPane.ERROR_MESSAGE);
					return;
			...
			if (n == 1) {
				if (Barracks.isVisible())
					JOptionPane.showMessageDialog(this, "YOU HAVE ALREADY BUILT ONE!!", "ERROR!!!!!",
							JOptionPane.ERROR_MESSAGE);
				try {
					GameView.getGame().getPlayer().build("Barracks", "Sparta");
				} catch (NotEnoughGoldException e1) {
					e1.printStackTrace();
					JOptionPane.showMessageDialog(this, "NOT ENOUGH GOLD!!", "ERROR!!!!!", JOptionPane.ERROR_MESSAGE);
					return;
			...
			if (n == 3) {
				if (Farm.isVisible())
					JOptionPane.showMessageDialog(this, "YOU HAVE ALREADY BUILT ONE!!", "ERROR!!!!!",
							JOptionPane.ERROR_MESSAGE);
				try {
					GameView.getGame().getPlayer().build("Farm", "Sparta");
				} catch (NotEnoughGoldException e1) {
					e1.printStackTrace();
					JOptionPane.showMessageDialog(this, "NOT ENOUGH GOLD!!", "ERROR!!!!!", JOptionPane.ERROR_MESSAGE);
					return;
		...
		if (e.getSource() == ArcheryRange) {
			...
			case 1:
				try {
					GameView.getGame().getPlayer().recruitUnit("Archer", "Sparta");
					updatedefRec();
					GameView.updateAll();
		...
		if (e.getSource() == Barracks) {
			...
			case 1:
				try {
					...
					GameView.getGame().getPlayer().recruitUnit("Infantry", "Sparta");
					updatedefRec();
					GameView.updateAll();
					setprompt("Barracks");
				} catch (BuildingInCoolDownException e1) {
		...
		if (e.getSource() == Stable) {
			...
			case 1:
				try {
					...
					GameView.getGame().getPlayer().recruitUnit("Cavalry", "Sparta");
					updatedefRec();
					GameView.updateAll();
					setprompt("Stable");
				} catch (BuildingInCoolDownException e1) {
